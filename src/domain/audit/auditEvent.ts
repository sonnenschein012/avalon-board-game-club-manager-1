...
export const AUDIT_ACTION_LABELS = {
  ...
  'session.planning_deleted': '모임 진행 정보를 삭제했습니다. 세션 기록은 유지됩니다.',
  'session.planning_restored': '모임 진행 정보를 이전 버전으로 복원했습니다.',
  'session.planning_overwritten': '모임 진행 정보를 덮어쓰고 이전 버전을 보관했습니다.',
