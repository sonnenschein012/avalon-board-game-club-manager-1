...
describe('getMemberFromAttendee', () => {
  const members: Member[] = [
    { id: '1', name: '김철수', studentId: '20231111', gender: '남', semester: '1', nickname: '', phone: '', preferredGenre: [], createdAt: { toMillis: () => 0 } as any },
    { id: '2', name: '홍길동', studentId: '20220000', gender: '남', semester: '1', nickname: '', phone: '', preferredGenre: [], createdAt: { toMillis: () => 0 } as any },
    { id: '3', name: '이영희', studentId: '23555555', gender: '여', semester: '1', nickname: '', phone: '', preferredGenre: [], createdAt: { toMillis: () => 0 } as any },
    { id: '4', name: '김철수', studentId: '20211111', gender: '남', semester: '1', nickname: '', phone: '', preferredGenre: [], createdAt: { toMillis: () => 0 } as any },
  ];
