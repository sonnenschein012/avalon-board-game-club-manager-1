...
현재 안정 기준은 [v1.0.1](https://github.com/sonnenschein012/avalon-board-game-club-manager-1/releases/tag/v1.0.1)입니다. 개발을 재개할 때는 아래 실행 환경 안내와 [개발 가이드](docs/development.md)에서 시작하세요.
